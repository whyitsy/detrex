...
python demo/demo.py --config-file projects/dino/configs/dino-swin/dino_swin_tiny_224_4scale_12ep.py --multi_view_input "./demo_test"  --metadata_dataset shampoo_train_datasets --opts train.init_checkpoint="/mnt/data/kky/output/dino_swin_tiny_224_4scale_12ep/model_0059999.pth"
```
...
后两天：使用配准后再进行追踪，这样就可以降低跳帧带来的影响。对齐后